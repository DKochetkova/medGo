...
import 'package:medGo/models/user.dart';
import 'package:medGo/widgets/MedicineSlected.dart';
class MedicineSelected extends StatefulWidget {
  @override
  _MedicineSelectedState createState() => _MedicineSelectedState();
}

class _MedicineSelectedState extends State<MedicineSelected> {
  User currentUser=User.init().getCurrentUser();
  model.MedicineList medicineList;
  void initState() {
    this.medicineList = new model.MedicineList();
    super.initState();
  }
  @override
                        ...
                        children: <Widget>[
                          ListView.separated(
                            ...
                            itemBuilder: (context,index){
                              return MedicineSelectedList(
                                Medicine: medicineList.medicine.elementAt(index),
                              );
                            },
                          ),
                          Container(
